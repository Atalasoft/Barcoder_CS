# Atalasoft DotImage Barcode Reader demo application
Demo C# application showing the usage of barcode reading functionality that [DotImage](https://www.atalasoft.com/Products/DotImage) product provides.
